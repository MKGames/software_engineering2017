...
CSV.foreach(input_csv_file_with_links) do |row| 
	...
	r2 = `curl -s -F \"file=@./A_12_Karina_Kozarova.csv\" #{current_url}/filters`
	r3 = `curl -s -F \"file=@./A_12_Karina_Kozarova.csv\" #{current_url}/intervals`
   	r4 = `curl -s -F \"file=@./A_12_Karina_Kozarova.csv\" #{current_url}/lin_regressions`  
